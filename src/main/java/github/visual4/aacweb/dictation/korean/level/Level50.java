...
public class Level50 implements ILevel {
	String pattern ="가까이,가만히,감사히,고요히,고이,곰곰이,괜히,굉장히,급히,깨끗이,꼼꼼히,나날이,낱낱이,높이,다소곳이,도저히,많이,반듯이,버젓이,부지런히,분명히,샅샅이,새로이,솔직히,쓸쓸히,안녕히,열심히,우연히,자세히,정확히,조용히,줄줄이,즐거이,천천히,특히,틈틈이";
